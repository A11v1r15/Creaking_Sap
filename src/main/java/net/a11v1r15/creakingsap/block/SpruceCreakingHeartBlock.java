...
import net.a11v1r15.creakingsap.block.entity.SpruceCreakingHeartBlockEntity;
...
public class SpruceCreakingHeartBlock extends AbstractCreakingHeartBlock {
    protected SpruceCreakingHeartBlock(Settings settings) {
        super(settings);
    }
    ...
    public static boolean shouldBeEnabled(BlockState state, WorldView world, BlockPos pos) {
        ...
        for (Direction direction : directions) {
            ...
            if (!blockState.isIn(BlockTags.SPRUCE_LOGS) || blockState.get(AXIS) != axis) {
                return false;
            }
        }
