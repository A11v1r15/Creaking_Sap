...
import net.a11v1r15.creakingsap.block.DarkOakCreakingHeartBlock;
...
public class DarkOakCreakingHeartBlockEntity extends AbstractCreakingHeartBlockEntity {
    ...
    public static void tick(World world, BlockPos pos, BlockState state, AbstractCreakingHeartBlockEntity blockEntity) {
        ...
        if (blockEntity.creakingUpdateTimer-- < 0) {
            ...
            if (blockEntity.creakingPuppet != null) {
                if (DarkOakCreakingHeartBlock.isWorldNaturalAndNight(world) && !(blockEntity.creakingPuppet.squaredDistanceTo(Vec3d.ofBottomCenter(pos)) > 1156.0)) {
            ...
            } else if (!DarkOakCreakingHeartBlock.shouldBeEnabled(state, world, pos)) {
                world.setBlockState(pos, state.with(AbstractCreakingHeartBlock.CREAKING, AbstractCreakingHeartBlock.Creaking.DISABLED), 3);
            } else {
                if (!DarkOakCreakingHeartBlock.isWorldNaturalAndNight(world)) {
